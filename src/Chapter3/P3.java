...
/**
 * Check if a number is in a range from 1-100
 * Check if your first and second numbers are equal
 * Check if your two numbers make a proper fraction 
 * Check what letter grade the first number would be in an A-F grading scale
 * 
 * @author Conner Kious
 */
public class P3 {
